...
const FilterBlock = () => {
  const [state, dispatch] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_4__.useReducer)(reducer, initialState);
  const {
    control,
    handleSubmit,
    reset,
  ...
  const fetchCategories = () => {
    _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_5___default()({
      path: "/wp/v2/categories?exclude=1"
    }).then(categories => {
      dispatch({
        type: "SET_CATEGORIES",
        payload: categories
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_4__.useEffect)(() => {
    ...
    const tags = params.getAll('tags[]').map(slug => ({
      slug
    }));
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("form", {
    ...
    className: "filterControl__item filterControl__item--keyword"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("strong", {
    className: "filterControl--tit"
  }, "Keyword"), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_hook_form__WEBPACK_IMPORTED_MODULE_7__.Controller, {
    name: "keyword",
    control: control,
    render: ({
      field
    ...
    className: "filterControl__item filterControl__item--categories"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("strong", {
    className: "filterControl--tit"
  }, "Categories"), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_hook_form__WEBPACK_IMPORTED_MODULE_7__.Controller, {
    name: "category",
    control: control,
    render: ({
      field
    ...
    className: "filterControl__item filterControl__item--tags"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("strong", {
    className: "filterControl--tit"
  }, "Tags"), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_hook_form__WEBPACK_IMPORTED_MODULE_7__.Controller, {
    name: "tags",
    control: control,
    render: ({
      field: {
      ...
      justify: "flex-start"
    }, tags.map(tag => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.CheckboxControl, {
      key: tag.slug,
      label: tag.name,
      checked: value.some(v => v.slug === tag.slug),
      onChange: () => {
        const newValue = value.some(v => v.slug === tag.slug) ? value.filter(v => v.slug !== tag.slug) : [...value, {
          slug: tag.slug
        }];
        onChange(newValue);
      }
    ...
    className: "filterControl__item filterControl__item--submit"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
    type: "submit"
  }, "Search"))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "filterBlocks"
    ...
    className: "filterBlock__thumb"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("img", {
    src: post.thumbnail_url || "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mPs7+m/CAAF2QJ9Ghl9ggAAAABJRU5ErkJggg==",
    alt: post.name,
    width: "150",
    height: "150"
  })), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "filterBlock__content"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("strong", {
    className: "filterBlock__content--tit"
  }, post.name), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
    className: "filterBlock__content--des"
  }, post.description))))), maxPages > 1 && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_2__.registerBlockType)("itc/itc-filter", {
  title: "ITC Filter",
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (root) {
    react_dom__WEBPACK_IMPORTED_MODULE_6___default().render((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(FilterBlock, null), root);
  }
});
